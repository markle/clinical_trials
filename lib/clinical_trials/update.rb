...
module ClinicalTrials
  ...
  class Update
   ...
   def nct_lists
     @nct_list ||= ClinicalTrials::ScrippsNctList.get_trials(@config['nct_file'])
   end
   def imedris_lists
     @imedris_list ||= ClinicalTrials::ScrippsImedrisList.get_trials(@config['imedris_file'])
   end
  ...
  def to_update
    ...
    return [] unless keep
    keepers = keep.collect {|irb_number|
