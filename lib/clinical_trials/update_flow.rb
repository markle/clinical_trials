# changed the implementation, a lot of this will have to be reimpemented in the app which implements this.
# clinical trials just returns a list of trials, nothing fancy
# the to_update and to_add classes are still gonna have to happen tho.
